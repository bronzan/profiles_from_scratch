...
min_y <- min(d1[m,]) - 10
plot(1, type="n", axes = FALSE, xlim=c(1,365), ylim=c(min(d1[m,]) - 10 ,max(d2[m,]) + 10), xlab="Month", ylab="tmax(F)", main=bothprof[m,1])
...
legend(180,min_y + 15, "2016", col="green", lwd=3, box.lwd=0, box.col="white")
